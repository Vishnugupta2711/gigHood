...
function parseFormulaString(
  formula?: string,
): Array<{ label: string; value: string; tone: "pos" | "neg" | "neutral" }> {
  if (!formula) return [];
  const rows: Array<{
    label: string;
    value: string;
...
function tierGradient(tier: string): string {
  switch (tier) {
    case "A":
      return "linear-gradient(135deg, rgba(139,92,246,0.4) 0%, rgba(59,130,246,0.2) 100%)";
    case "B":
      return "linear-gradient(135deg, rgba(59,130,246,0.4) 0%, rgba(16,185,129,0.2) 100%)";
    case "C":
      return "linear-gradient(135deg, rgba(245,158,11,0.4) 0%, rgba(239,68,68,0.18) 100%)";
    default:
      return "linear-gradient(135deg, rgba(59,130,246,0.4) 0%, rgba(16,185,129,0.2) 100%)";
  }
}

const POLICY_CERTIFICATE_BASE_URL =
  "https://ifddoiwbxvfxsidksydf.supabase.co/storage/v1/object/public/policy_certificates";
...
export default function ProfilePage() {
  ...
  const claimRisk = normalizeRiskLabel(
    policy?.tier_explanation?.claim_frequency_band,
  );
  const formulaRows = parseFormulaString(
    worker?.trust_breakdown?.formula_string,
  );
  const totalTrust = ts;
        ...
        >
          <div
            style={{
              ...
              maxWidth: "440px",
              background:
                "linear-gradient(180deg, rgba(20,28,48,0.98) 0%, rgba(9,14,26,1) 100%)",
          ...
          >
            ...
            <button
              ...
              disabled={
                saving || !earningsInput || parseFloat(earningsInput) <= 0
              }
              style={{
                width: "100%",
                padding: "14px",
      ...
      >
        ...
        >
          <div>
            ...
            >
              ...
              />
              Protection Active · Monitoring your zone
            </p>
          </div>
          <button
        ...
        >
          ...
          <div
            style={{
              ...
              bottom: "-50%",
              background:
                "linear-gradient(60deg, transparent 40%, rgba(255,255,255,0.1) 50%, transparent 60%)",
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontSize: "11px",
                  fontWeight: 700,
                  background: worker?.is_platform_verified
                    ? "rgba(16, 185, 129, 0.15)"
                    : "rgba(148, 163, 184, 0.14)",
                  color: worker?.is_platform_verified ? "#34D399" : "#CBD5E1",
                  border: worker?.is_platform_verified
          ...
          >
            Secured by AI risk monitoring system
          </p>
        </div>
        ...
        <section className="stagger-3 glass-panel" style={{ padding: "18px" }}>
          ...
          >
            ...
            >
              ...
              >
                {policy
                  ? `₹${policy?.weekly_premium ?? policy?.premium_amount ?? "—"}/week`
                  : "—"}
              </p>
            </div>
          ...
          >
            ...
            >
              Payouts are automatic. No claims required. If the Dynamic Coverage
              Index (DCI) in your zone exceeds 0.85 due to severe weather or
              traffic, your coverage is triggered.
            </p>
            <p
              style={{
                fontSize: "12px",
            ...
            >
              ✔ Payouts are automatic — no claims needed
            </p>
            <p
              style={{
                fontSize: "11px",
            ...
            {policy?.tier_explanation && (
              ...
              >
                ...
                >
                  ...
                  >
                    Based on your zone risk and recent claim patterns, your
                    coverage is set to Tier {tier}.
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      raw: {policy.tier_explanation.avg_dci_4w}
                    </p>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      raw: {policy.tier_explanation.claim_frequency_28d}
                    </p>
                  </div>
                </div>
                ...
                <div style={{ marginTop: "8px" }}>
                  ...
                  >
                    {policy.tier_explanation.seasonal_text ||
                      (policy.tier_explanation.seasonal_flag
                        ? "Monsoon Season"
                        : "Regular Season")}{" "}
                    • {policy.tier_explanation.city}
                  </span>
                </div>
              </div>
            )}
        ...
        <section className="stagger-4 glass-panel" style={{ padding: "16px" }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <circle
                  ...
                  fill="none"
                  strokeDasharray="251"
                  strokeDashoffset={251 - (251 * ts) / 100}
                  strokeLinecap="round"
              ...
              >
                <div
                  style={{ fontSize: "20px", fontWeight: 800, color: tColor }}
                >
                  {ts.toFixed(0)}
                </div>
                <div
            ...
            >
              {ts > 85
                ? "System trusts you — fast payouts enabled"
                : ts > 70
                  ? "Stable profile — standard processing"
                  : "System is monitoring activity closely"}
            </p>
          </div>
          ...
          >
            ...
            <span style={{ fontSize: "18px", fontWeight: 800, color: tColor }}>
              {totalTrust.toFixed(1)}
            </span>
          </div>
          <p
            style={{
          ...
          <button
            ...
            onClick={() => {
              if (!policyCertificateUrl) {
                showToast(
                  "Policy certificate unavailable. Tier not assigned yet.",
                );
                return;
              }
              window.open(
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                ...
                >
                  {t(language, "download_tier_policy")}
                </div>
                <div
                  style={{
                    fontSize: "12px",
