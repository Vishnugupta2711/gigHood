...
Core innovation: DCI asks "Has earning _opportunity_ collapsed?" (not just "Is it raining?"), eliminating basis risk via a sigmoid fusion of weather (W), traffic (T), platform status (P), and social disruption (S) signals.
